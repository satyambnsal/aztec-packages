 ...
 *
 */
class pow_2_lookups_1_lookup_settings {
  public:
    /**
    ...
    {
        return (in.avm_alu_pow_2_sel == 1 || in.avm_main_sel_rng_8 == 1);
    }
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        ...
        const auto is_operation = View(in.avm_alu_pow_2_sel);
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.pow_2_lookups_1,
                                     in.pow_2_lookups_1_counts,
                                     in.avm_alu_pow_2_sel,
                                     in.avm_main_sel_rng_8,
                                     in.avm_alu_t_sub_b_bits,
                                     in.avm_alu_two_pow_t_sub_b,
                                     in.avm_main_clk,
...
template <typename FF_> using pow_2_lookups_1_relation = GenericLookupRelation<pow_2_lookups_1_lookup_settings, FF_>;
template <typename FF_> using pow_2_lookups_1 = GenericLookup<pow_2_lookups_1_lookup_settings, FF_>;
