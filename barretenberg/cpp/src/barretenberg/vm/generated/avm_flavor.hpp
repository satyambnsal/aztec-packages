...
#include "barretenberg/relations/generated/avm/pow_2_lookups.hpp"
#include "barretenberg/relations/generated/avm/pow_2_lookups_1.hpp"
...
class AvmFlavor {
  public:
    ...
    static constexpr size_t NUM_WITNESS_ENTITIES = 223;
    static constexpr size_t NUM_WIRES = NUM_WITNESS_ENTITIES + NUM_PRECOMPUTED_ENTITIES;
    // We have two copies of the witness entities, so we subtract the number of fixed ones (they have no shift), one for
    // the unshifted and one for the shifted
    static constexpr size_t NUM_ALL_ENTITIES = 254;
    ...
    using GrandProductRelations = std::tuple<perm_main_alu_relation<FF>,
                                             ...
                                             pow_2_lookups_relation<FF>,
                                             pow_2_lookups_1_relation<FF>,
    ...
    template <typename DataType> class WitnessEntities {
      public:
        DEFINE_FLAVOR_MEMBERS(DataType,
                              ...
                              avm_alu_rng_chk_sel,
                              avm_alu_t_sub_b_bits,
                              avm_alu_two_pow_b,
                              avm_alu_two_pow_t_sub_b,
                              avm_alu_u128_tag,
                              avm_alu_u16_r0,
                              avm_alu_u16_r1,
                              avm_alu_u16_r10,
                              ...
                              pow_2_lookups_counts,
                              pow_2_lookups_1_counts,
                              lookup_u8_0_counts,
                              lookup_u8_1_counts,
                              lookup_u16_0_counts,
                              lookup_u16_1_counts,
  ...
  public:
      ...
      public:
        ...
        void compute_logderivative_inverses(const RelationParameters<FF>& relation_parameters)
        {
            ...
            bb::compute_logderivative_inverse<AvmFlavor, incl_mem_tag_err_relation<FF>>(
                prover_polynomials, relation_parameters, this->circuit_size);
            bb::compute_logderivative_inverse<AvmFlavor, pow_2_lookups_relation<FF>>(
                prover_polynomials, relation_parameters, this->circuit_size);
            bb::compute_logderivative_inverse<AvmFlavor, pow_2_lookups_1_relation<FF>>(
                prover_polynomials, relation_parameters, this->circuit_size);
    ...
    class CommitmentLabels : public AllEntities<std::string> {
      ...
      public:
            ...
            : AllEntities<std::string>()
        {
            ...
            Base::avm_alu_op_shl = "AVM_ALU_OP_SHL";
            Base::avm_alu_op_shr = "AVM_ALU_OP_SHR";
            ...
            Base::avm_alu_pow_2_sel = "AVM_ALU_POW_2_SEL";
            ...
            Base::avm_alu_t_sub_b_bits = "AVM_ALU_T_SUB_B_BITS";
            Base::avm_alu_two_pow_b = "AVM_ALU_TWO_POW_B";
            Base::avm_alu_two_pow_t_sub_b = "AVM_ALU_TWO_POW_T_SUB_B";
            ...
            Base::pow_2_lookups = "POW_2_LOOKUPS";
            Base::pow_2_lookups_1 = "POW_2_LOOKUPS_1";
            ...
            Base::pow_2_lookups_counts = "POW_2_LOOKUPS_COUNTS";
            Base::pow_2_lookups_1_counts = "POW_2_LOOKUPS_1_COUNTS";
    ...
    class Transcript : public NativeTranscript {
      public:
        ...
        Commitment avm_alu_op_shl;
        Commitment avm_alu_op_shr;
        ...
        Commitment avm_alu_t_sub_b_bits;
        Commitment avm_alu_two_pow_b;
        Commitment avm_alu_two_pow_t_sub_b;
        ...
        Commitment pow_2_lookups;
        Commitment pow_2_lookups_1;
        ...
        Commitment pow_2_lookups_counts;
        Commitment pow_2_lookups_1_counts;
        ...
        void deserialize_full_transcript()
        {
            ...
            avm_alu_op_shl = deserialize_from_buffer<Commitment>(Transcript::proof_data, num_frs_read);
            avm_alu_op_shr = deserialize_from_buffer<Commitment>(Transcript::proof_data, num_frs_read);
            ...
            avm_alu_pow_2_sel = deserialize_from_buffer<Commitment>(Transcript::proof_data, num_frs_read);
            ...
            avm_alu_t_sub_b_bits = deserialize_from_buffer<Commitment>(Transcript::proof_data, num_frs_read);
            avm_alu_two_pow_b = deserialize_from_buffer<Commitment>(Transcript::proof_data, num_frs_read);
            avm_alu_two_pow_t_sub_b = deserialize_from_buffer<Commitment>(Transcript::proof_data, num_frs_read);
            ...
            pow_2_lookups = deserialize_from_buffer<Commitment>(Transcript::proof_data, num_frs_read);
            pow_2_lookups_1 = deserialize_from_buffer<Commitment>(Transcript::proof_data, num_frs_read);
            ...
            pow_2_lookups_counts = deserialize_from_buffer<Commitment>(Transcript::proof_data, num_frs_read);
            pow_2_lookups_1_counts = deserialize_from_buffer<Commitment>(Transcript::proof_data, num_frs_read);
        ...
        void serialize_full_transcript()
        {
            ...
            serialize_to_buffer<Commitment>(avm_alu_op_shl, Transcript::proof_data);
            serialize_to_buffer<Commitment>(avm_alu_op_shr, Transcript::proof_data);
            ...
            serialize_to_buffer<Commitment>(avm_alu_pow_2_sel, Transcript::proof_data);
            ...
            serialize_to_buffer<Commitment>(avm_alu_t_sub_b_bits, Transcript::proof_data);
            serialize_to_buffer<Commitment>(avm_alu_two_pow_b, Transcript::proof_data);
            serialize_to_buffer<Commitment>(avm_alu_two_pow_t_sub_b, Transcript::proof_data);
            ...
            serialize_to_buffer<Commitment>(pow_2_lookups, Transcript::proof_data);
            serialize_to_buffer<Commitment>(pow_2_lookups_1, Transcript::proof_data);
            ...
            serialize_to_buffer<Commitment>(pow_2_lookups_counts, Transcript::proof_data);
            serialize_to_buffer<Commitment>(pow_2_lookups_1_counts, Transcript::proof_data);
